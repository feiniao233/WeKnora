...
// WithRequiredImages marks user-supplied images as mandatory. Protocol
// clients must surface a capability error instead of silently retrying after
...
// RequiresImages reports whether the current request contains mandatory
